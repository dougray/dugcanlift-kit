...
public final class Recipe {
    ...
    public var nutritionIsEstimated: Bool = false
    ...
    public var totalWeightGrams: Double?
    ...
    public var foodRefID: String { "recipe:\(id.uuidString)" }

    public var wasImported: Bool { sourceURL != nil }
    ...
    public var totalNutrition: NutritionFacts? {
    ...
    public var nutritionPerGram: NutritionFacts? {
...
public final class PlannedMeal {
    ...
    public var plannedFor: Date = Date.now
    ...
    /// the log.
    public var snapshotNutrition: NutritionFacts?
    ...
    public var snapshotNutritionPerGram: NutritionFacts?

    /// Set when this plan has been turned into an actual `FoodEntry`, so
    /// logging twice is visible and idempotent.
    public var loggedFoodEntryID: UUID?

    public init(recipe: Recipe, mealType: MealType, plannedFor: Date, servings: Double = 1, amountGrams: Double? = nil) {
        self.id = UUID()
    ...
    public var isLogged: Bool { loggedFoodEntryID != nil }
    ...
    public var scaledNutrition: NutritionFacts? {
    ...
    public func makeFoodEntry() -> FoodEntry? {
...
@Model
public final class ShoppingListCheck {
    public var id: UUID = UUID()
    /// Lowercased, whitespace-trimmed item name.
    public var itemKey: String = ""
    public var checkedAt: Date = Date.now

    public init(itemKey: String, checkedAt: Date = .now) {
        self.id = UUID()
...
public struct ShoppingListLine: Identifiable, Hashable {
...
public enum ShoppingList {
    ...
    public static func build(from meals: [PlannedMeal],
